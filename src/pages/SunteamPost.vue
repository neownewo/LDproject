  ...
  <AppLayout>
    <section class="post-shell">
      <div class="post-header">
        <button class="back-btn" type="button" @click="goBack">← 返回 Sunteam 列表</button>
...
// 從 Sunteam.vue 傳進來：/sunteam-post?title=xxx&link=Notion網址
...
const articleTitle = computed(() => {
  const title = route.query.title || route.params.slug || 'Sunteam 文章'
  return typeof title === 'string' ? title : 'Sunteam 文章'
})
